...
activities = {
    ...
    "Soccer Club": {
        "description": "Recreational soccer training and local tournaments",
        "schedule": "Wednesdays, 4:00 PM - 6:00 PM",
        "max_participants": 22,
        "participants": ["liam@mergington.edu", "maya@mergington.edu"]
    },
    "Art Club": {
        "description": "Explore visual arts, painting, and drawing techniques",
    ...
    "Debate Team": {
        ...
        "max_participants": 12,
        "participants": ["noah@mergington.edu", "sophia_debate@mergington.edu"]
    },
    "Science Olympiad": {
